...
def breadthFirstSearch(problem):
    ...
    def addFringe(someFringe, state, cost):
        someFringe.push(state)
...
def greedyBFS(problem, heuristic=nullHeuristic):
    ...
    def addFringe(someFringe, state, cost):
        newCost = heuristic(state[0], problem)
        someFringe.push(state, newCost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    def addFringe(someFringe, state, cost):
        newCost = cost + heuristic(state[0], problem)
        someFringe.push(state, newCost)
